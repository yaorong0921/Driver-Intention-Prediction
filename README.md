...
The trained model using our script can be found under this [link](https://tumde-my.sharepoint.com/:f:/r/personal/yao_rong_tum_de/Documents/Driver-Intention-Prediction?csf=1&web=1&e=on18WG). The model name is "save_best_3DResNet50.pth".
...
You could also find these optical flow images under this [link](https://tumde-my.sharepoint.com/:f:/r/personal/yao_rong_tum_de/Documents/Driver-Intention-Prediction?csf=1&web=1&e=on18WG).
